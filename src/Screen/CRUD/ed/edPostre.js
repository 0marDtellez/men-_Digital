...
const EdiPostre = () =>{
    ...
    const update = async (e) => {
        e.preventDefault()
        const product = doc(db,"postre",id)
        const data = {
    ...
    const getProductById = async (id) => {
        const product = await getDoc( doc(db,"postre",id))
            if(product.exists()){
                ...
                // //ingredientes
                setCanti1(product.data().IngredientesPrincipales.cantidad)
                setPeso1(product.data().IngredientesPrincipales.peso)
                setIngre1(product.data().IngredientesPrincipales.nombre)
                setPreIng1(product.data().IngredientesPrincipales.precio)
                // ingredientes
